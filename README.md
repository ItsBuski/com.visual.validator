...
Python 3.x installed and added to your Windows PATH.



OpenCV library for Python (pip install opencv-python numpy).
...
Headless frame capture in Unity.
...
Unity will restart automatically once finished.
